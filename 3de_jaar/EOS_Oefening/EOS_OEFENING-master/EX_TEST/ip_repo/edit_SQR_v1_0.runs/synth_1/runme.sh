...
HD_PWD='c:/users/kasperpc/desktop/eos_examen/ex_test/ip_repo/edit_SQR_v1_0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SQR_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SQR_v1_0.tcl
