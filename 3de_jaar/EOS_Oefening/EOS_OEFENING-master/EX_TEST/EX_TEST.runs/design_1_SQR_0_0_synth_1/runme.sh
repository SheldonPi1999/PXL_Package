...
HD_PWD='C:/Users/KasperPC/Desktop/EOS_Examen/EX_TEST/EX_TEST.runs/design_1_SQR_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_SQR_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_SQR_0_0.tcl
