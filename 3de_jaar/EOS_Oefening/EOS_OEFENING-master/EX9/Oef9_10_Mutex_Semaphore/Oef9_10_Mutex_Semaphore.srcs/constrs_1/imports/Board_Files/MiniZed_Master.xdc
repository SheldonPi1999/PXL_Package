...
# ---------------------------------------------------------------------------- 
# Bank 34
#set_property PACKAGE_PIN M15 [get_ports {leds_4bits[0]}];  # "M15.PMOD1_D0_N"
#set_property PACKAGE_PIN L15 [get_ports {leds_4bits[1]}];  # "L15.PMOD1_D0_P"
#set_property PACKAGE_PIN M14 [get_ports {leds_4bits[2]}];  # "M14.PMOD1_D1_N"
#set_property PACKAGE_PIN L14 [get_ports {leds_4bits[3]}];  # "L14.PMOD1_D1_P"
