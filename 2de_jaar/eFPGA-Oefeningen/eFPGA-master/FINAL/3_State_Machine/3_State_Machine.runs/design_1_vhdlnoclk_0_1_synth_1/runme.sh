...
HD_PWD='C:/eFPGA/3_State_Machine/3_State_Machine.runs/design_1_vhdlnoclk_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_vhdlnoclk_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_vhdlnoclk_0_1.tcl
