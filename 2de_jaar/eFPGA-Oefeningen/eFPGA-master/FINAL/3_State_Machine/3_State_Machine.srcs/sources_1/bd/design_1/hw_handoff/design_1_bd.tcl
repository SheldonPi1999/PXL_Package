...
proc create_root_design { parentCell } {
  ...
  set light_reset_0 [ create_bd_port -dir I -type rst light_reset_0 ]
  ...
  connect_bd_net -net light_reset_0_1 [get_bd_ports light_reset_0] [get_bd_pins main_0/light_reset]
  connect_bd_net -net main_0_LED_G [get_bd_ports LED_G] [get_bd_pins main_0/LED_G]
  connect_bd_net -net main_0_LED_R [get_bd_ports LED_R] [get_bd_pins main_0/LED_R]
  connect_bd_net -net vhdlnoclk_0_clk65MHz [get_bd_pins main_0/clk_65MHz] [get_bd_pins vhdlnoclk_0/clk65MHz]
