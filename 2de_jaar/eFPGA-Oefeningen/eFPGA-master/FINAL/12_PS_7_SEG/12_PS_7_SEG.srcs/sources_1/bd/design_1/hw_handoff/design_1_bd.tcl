...
proc create_root_design { parentCell } {
  ...
  set SEVEN_SEG [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 SEVEN_SEG ]
  ...
  connect_bd_intf_net -intf_net axi_gpio_0_GPIO [get_bd_intf_ports SEVEN_SEG] [get_bd_intf_pins axi_gpio_0/GPIO]
  connect_bd_intf_net -intf_net processing_system7_0_DDR [get_bd_intf_ports DDR] [get_bd_intf_pins processing_system7_0/DDR]
  connect_bd_intf_net -intf_net processing_system7_0_FIXED_IO [get_bd_intf_ports FIXED_IO] [get_bd_intf_pins processing_system7_0/FIXED_IO]
  connect_bd_intf_net -intf_net processing_system7_0_GPIO_0 [get_bd_intf_ports GPIO_SW] [get_bd_intf_pins processing_system7_0/GPIO_0]
