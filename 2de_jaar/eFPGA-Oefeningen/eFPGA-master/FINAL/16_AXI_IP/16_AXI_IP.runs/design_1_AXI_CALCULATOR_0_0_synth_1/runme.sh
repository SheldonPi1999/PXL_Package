...
HD_PWD='C:/eFPGA/16_AXI_IP/16_AXI_IP.runs/design_1_AXI_CALCULATOR_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_AXI_CALCULATOR_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_AXI_CALCULATOR_0_0.tcl
