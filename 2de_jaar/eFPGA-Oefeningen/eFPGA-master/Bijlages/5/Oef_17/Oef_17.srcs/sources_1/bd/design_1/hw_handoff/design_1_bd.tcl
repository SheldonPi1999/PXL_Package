...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set outNPwm_0 [ create_bd_port -dir O outNPwm_0 ]
  set outPwm_0 [ create_bd_port -dir O outPwm_0 ]
  ...
  connect_bd_net -net PWM_0_outNPwm [get_bd_ports outNPwm_0] [get_bd_pins PWM_0/outNPwm]
  connect_bd_net -net PWM_0_outPwm [get_bd_ports outPwm_0] [get_bd_pins PWM_0/outPwm]
