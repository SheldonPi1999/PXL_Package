...
HD_PWD='C:/eFPGA/2_Simple_VHDL/2_Simple_VHDL.runs/design_1_VHDL_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_VHDL_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_VHDL_0_0.tcl
