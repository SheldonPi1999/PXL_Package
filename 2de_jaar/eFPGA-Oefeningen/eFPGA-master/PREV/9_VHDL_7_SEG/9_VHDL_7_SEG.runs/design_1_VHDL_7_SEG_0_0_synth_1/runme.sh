...
HD_PWD='C:/eFPGA/9_VHDL_7_SEG/9_VHDL_7_SEG.runs/design_1_VHDL_7_SEG_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_VHDL_7_SEG_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_VHDL_7_SEG_0_0.tcl
