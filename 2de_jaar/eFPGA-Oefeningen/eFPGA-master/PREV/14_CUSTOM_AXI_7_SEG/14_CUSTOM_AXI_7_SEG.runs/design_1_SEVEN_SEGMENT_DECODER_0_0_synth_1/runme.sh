...
HD_PWD='C:/eFPGA/14_CUSTOM_AXI_7_SEG/14_CUSTOM_AXI_7_SEG.runs/design_1_SEVEN_SEGMENT_DECODER_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_SEVEN_SEGMENT_DECODER_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_SEVEN_SEGMENT_DECODER_0_0.tcl
